...
atrous convolution. The experimental results prove that an image 
pyramid resizing augmentation can also improve efficiency. Our 
proposed segmentation method achieves an accuracy of 94% on the 
person segmentation dataset built in this work, which exceeds the 
results of previous state-of-the art methods in accuracy and efficiency.
