...
import com.aspire.inno.common.Configuration;
import com.aspire.inno.common.ModelConfig;
import com.aspire.inno.segmentation.ModelSelector;
import com.aspire.inno.segmentation.MaskProcessor;
import com.aspire.inno.common.MessageEvent;
import com.aspire.inno.segmentation.Segmenter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void saveImage(Bitmap finalBitmap) {
        ...
        photoPicPath = storagePath + File.separator
                + Calendar.getInstance().getTimeInMillis()+"out" + ".jpg";
